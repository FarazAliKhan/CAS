...
function loadFoundRecord() {
    ...
    fields.forEach(f => {
        ...
        switch (f.name) {
            ...
            case "FIELD1_1_4": $("#txtFIELD1_1_4").val(Math.floor(Number(f.value))); break;
            case "FIELD1_1_5": $("#txtFIELD1_1_5").val(Math.floor(Number(f.value))); break;
            case "FIELD1_1_6": $("#txtFIELD1_1_6").val(Math.floor(Number(f.value))); break;
            case "FIELD1_1_7": $("#txtFIELD1_1_7").val(Math.floor(Number(f.value))); break;
            case "COMMENTSECTION1": $("#txtFIELD_1_Comments").val(f.value); break;
            case "FIELD1_2_1": $("#txtFIELD1_2_1").val(Math.floor(Number(f.value))); break;
            case "FIELD1_2_2": $("#txtFIELD1_2_2").val(Math.floor(Number(f.value))); break;
            case "FIELD1_2_3": $("#txtFIELD1_2_3").val(Math.floor(Number(f.value))); break;
            case "FIELD1_2_4": $("#txtFIELD1_2_4").val(Math.floor(Number(f.value))); break;
            case "FIELD1_2_5": $("#txtFIELD1_2_5").val(Math.floor(Number(f.value))); break;
            case "FIELD2_1_1": $("#txtFIELD2_1_1").val(Math.floor(Number(f.value))); break;
            case "FIELD2_1_2": $("#txtFIELD2_1_2").val(Math.floor(Number(f.value))); break;
            case "FIELD2_2_1": $("#txtFIELD2_2_1").val(Math.floor(Number(f.value))); break;
            case "FIELD2_2_1_1": $("#txtFIELD2_2_1_1").val(Math.floor(Number(f.value))); break;
            case "FIELD2_2_1_2": $("#txtFIELD2_2_1_2").val(Math.floor(Number(f.value))); break;
            case "FIELD2_2_1_3": $("#txtFIELD2_2_1_3").val(Math.floor(Number(f.value))); break;
            case "FIELD2_2_2": $("#txtFIELD2_2_2").val(Math.floor(Number(f.value))); break;
            case "FIELD2_2_2_1": $("#txtFIELD2_2_2_1").val(Math.floor(Number(f.value))); break;
            case "FIELD2_2_2_2": $("#txtFIELD2_2_2_2").val(Math.floor(Number(f.value))); break;
            case "FIELD2_2_2_3": $("#txtFIELD2_2_2_3").val(Math.floor(Number(f.value))); break;
            case "COMMENTSECTION2": $("#txtFIELD_2_Comments").val(f.value); break;
            case "FIELD3_1": $("#txtFIELD3_1").val(Math.floor(Number(f.value))); break;
            case "FIELD3_2": $("#txtFIELD3_2").val(Math.floor(Number(f.value))); break;
            case "COMMENTSECTION3": $("#txtFIELD_3_Comments").val(f.value); break;
            case "FIELD4_1_1": $("#txtFIELD4_1_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_2": $("#txtFIELD4_1_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_3": $("#txtFIELD4_1_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_4_1": $("#txtFIELD4_1_4_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_4_2": $("#txtFIELD4_1_4_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_4_3": $("#txtFIELD4_1_4_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_5_1": $("#txtFIELD4_1_5_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_5_2": $("#txtFIELD4_1_5_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_5_3": $("#txtFIELD4_1_5_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_6_1": $("#txtFIELD4_1_6_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_6_2": $("#txtFIELD4_1_6_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_1_6_3": $("#txtFIELD4_1_6_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_1": $("#txtFIELD4_2_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_2": $("#txtFIELD4_2_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_3": $("#txtFIELD4_2_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_4_1": $("#txtFIELD4_2_4_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_4_2": $("#txtFIELD4_2_4_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_4_3": $("#txtFIELD4_2_4_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_5_1": $("#txtFIELD4_2_5_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_5_2": $("#txtFIELD4_2_5_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_5_3": $("#txtFIELD4_2_5_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_6_1": $("#txtFIELD4_2_6_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_6_2": $("#txtFIELD4_2_6_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_2_6_3": $("#txtFIELD4_2_6_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_1": $("#txtFIELD4_3_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_2": $("#txtFIELD4_3_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_3": $("#txtFIELD4_3_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_4_1": $("#txtFIELD4_3_4_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_4_2": $("#txtFIELD4_3_4_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_4_3": $("#txtFIELD4_3_4_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_5_1": $("#txtFIELD4_3_5_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_5_2": $("#txtFIELD4_3_5_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_5_3": $("#txtFIELD4_3_5_3").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_6_1": $("#txtFIELD4_3_6_1").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_6_2": $("#txtFIELD4_3_6_2").val(Math.floor(Number(f.value))); break;
            case "FIELD4_3_6_3": $("#txtFIELD4_3_6_3").val(Math.floor(Number(f.value))); break;
            case "COMMENTSECTION4": $("#txtFIELD_4_Comments").val(f.value); break;
            case "FIELD5_1": $("#txtFIELD5_1").val(Math.floor(Number(f.value))); break;
            case "FIELD5_2": $("#txtFIELD5_2").val(Math.floor(Number(f.value))); break;
            case "FIELD5_3": $("#txtFIELD5_3").val(Math.floor(Number(f.value))); break;
            case "FIELD5_4": $("#txtFIELD5_4").val(Math.floor(Number(f.value))); break;
            case "COMMENTSECTION5": $("#txtFIELD_5_Comments").val(f.value); break;
            case "FIELD6_1_1": $("#txtFIELD6_1_1").val(Math.floor(Number(f.value))); break;
            case "FIELD6_1_2": $("#txtFIELD6_1_2").val(Math.floor(Number(f.value))); break;
            case "FIELD6_1_3": $("#txtFIELD6_1_3").val(Math.floor(Number(f.value))); break;
            case "FIELD6_2_1": $("#txtFIELD6_2_1").val(Math.floor(Number(f.value))); break;
            case "FIELD6_2_2": $("#txtFIELD6_2_2").val(Math.floor(Number(f.value))); break;
            case "FIELD6_2_3": $("#txtFIELD6_2_3").val(Math.floor(Number(f.value))); break;
            case "FIELD6_3_1": $("#txtFIELD6_3_1").val(Math.floor(Number(f.value))); break;
            case "FIELD6_3_2": $("#txtFIELD6_3_2").val(Math.floor(Number(f.value))); break;
            case "FIELD6_3_3": $("#txtFIELD6_3_3").val(Math.floor(Number(f.value))); break;
            case "COMMENTSECTION6": $("#txtFIELD_6_Comments").val(f.value); break;
            case "FIELD7_1_1": $("#txtFIELD7_1_1").val(Math.floor(Number(f.value))); break;
            case "FIELD7_1_2": $("#txtFIELD7_1_2").val(Math.floor(Number(f.value))); break;
            case "FIELD7_1_3": $("#txtFIELD7_1_3").val(Math.floor(Number(f.value))); break;
            case "COMMENTSECTION7": $("#txtFIELD_7_Comments").val(f.value); break;
            case "FIELD8_1": $("#txtFIELD8_1").val(Math.floor(Number(f.value))); break;
            case "FIELD8_2": $("#txtFIELD8_2").val(Math.floor(Number(f.value))); break;
            case "FIELD8_3": $("#txtFIELD8_3").val(Math.floor(Number(f.value))); break;
            case "COMMENTSECTION8": $("#txtFIELD_8_Comments").val(f.value); break;
            case "FIELD9_1": $("#txtFIELD9_1").val(Math.floor(Number(f.value))); break;
            case "FIELD9_2": $("#txtFIELD9_2").val(Math.floor(Number(f.value))); break;
            case "COMMENTSECTION9": $("#txtFIELD_9_Comments").val(f.value); break;
            case "FIELD10_1": $("#txtFIELD10_1").val(Math.floor(Number(f.value))); break;
            case "COMMENTSECTION10": $("#txtFIELD_10_Comments").val(f.value); break;
            case "FIELD11_1": $("#txtFIELD11_1").val(Math.floor(Number(f.value))); break;
            case "FIELD11_2": $("#txtFIELD11_2").val(Math.floor(Number(f.value))); break;
